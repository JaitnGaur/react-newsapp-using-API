...
const Tech = () => {
    ...
    useEffect(() => {
        async function getData() {
            let response = await fetch('https://api.newscatcherapi.com/v2/latest_headlines?countries=IN&page_size=18&lang=en&when=24h&topic=tech',
                Headers = {
                    method: 'GET',
        ...
        <>
            ...
            {News.map(NewsEl => {
                return <div className="card" >
                    <img src={NewsEl.media} className="card-img-top" height="250px" width="100px" alt="News Image" />
                    <div className="card-body"  >
                        ...
                        <a href={NewsEl.link} target='_blank' className="btn btn-primary">Visit News</a>
                    </div>
                </div>;
            })}
        </>
