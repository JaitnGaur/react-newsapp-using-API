...
const Home = () => {
    ...
    useEffect(() => {
        async function getData() {
            let response = await fetch(`https://api.newscatcherapi.com/v2/latest_headlines?countries=IN&page_size=18&lang=en&when=24h&page=${pageNo}`,
                Headers = {
                    method: 'GET',
        ...
        <>
            <div className=" mt-2">
                <InfiniteScroll
                    ...
                    loader={<div className="spinner-border mt-5 " style={{ marginLeft: '50rem' }} role="status">
                        <span className="visually-hidden">Loading...</span>
                    </div>}>
